...
3) Access the `workbench` named `test-codegen-nov624-one-notebook`.
...
5) In the terminal, run `cd test-codegen-nov624-one` to navigate to your sample app's directory.
